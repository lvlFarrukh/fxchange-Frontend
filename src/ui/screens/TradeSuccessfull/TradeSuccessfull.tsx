                    ...
                    <View style={{justifyContent:'space-between',flex:1}}>
                        ...
                        <View style={{ paddingHorizontal: 30 }}>
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', borderBottomWidth: 1.2, borderColor: '#F1F1F1', paddingVertical: 20 }}>
                                ...
                                <View>
                                    <Text style={{ fontSize: 12 }}>CARD CURRENCY</Text>
                                    <Text style={{ fontWeight: '500', alignSelf: 'flex-end' }}>US Dollars</Text>
                                </View>
                            </View>
                        ...
                        <View>
                            ...
                            <Text style={{ textAlign: 'center' }}>
                                <Text>if you uploaded a Giftcard on the wrong section it will be</Text>
                                <Text>transferednand treated at the current rate</Text>
                                <Text>of the appropriate section</Text>
                            </Text>
                        </View>
