        ...
        <ScrollView>
          <View style={[styles.whiteCardBg, {height: height - 50}]}>
            ...
            <View style={{justifyContent: 'space-between'}}>
              ...
              <View style={{marginTop: height > 600 ? 20 : 0,}}>
                <MyText
                  style={{fontSize: 10, color: '#343434', textAlign: 'center'}}>
                  NOTE:
                </MyText>
                <MyText
                  style={{fontSize: 10, color: '#343434', textAlign: 'center'}}>
                  <MyText>
                    Your transaction will be treated with the actual{'\n'}
                  </MyText>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.9}
                style={{marginTop: height > 600 ? 20 : 10,}}>
                <MyText
                  style={{
                    alignSelf: 'center',
                    backgroundColor: '#d65d0e',
